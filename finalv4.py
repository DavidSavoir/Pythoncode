...
#f = open(r'C:\Users\david.savoir\Pythoncode\declaration.txt', 'r')
...
"""
    ...
    Next up write a function function to NOT count puctuation as part of length
...
t_dict = {}
for word in words:
    true_length = get_length(word)
    t_dict[true_length] = t_dict.get(true_length, 0) + 1
"""
