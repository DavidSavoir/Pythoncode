...
#textfile = open(r'C:\Users\david.savoir\Pythoncode\source.txt', 'a+')
textfile = open(r'C:\Pythoncode\source.txt', 'a+')
print (textfile.read())
...
"""
    ...
    I keep saying that, and yet you keep opening in 'r' mode to start.  No good.  Stop.
